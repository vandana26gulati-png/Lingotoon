  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          <h2 style={{ fontSize: '20px', margin: 0, color: 'var(--text-white)' }}>
            Script & Screenplay (Live Synced)
          </h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '13px', margin: '4px 0 0 0', maxWidth: '65ch' }}>
            ⚡ <b>Single Source of Truth:</b> Any changes made here to dialogue, scene action, camera, or timing automatically update the <b>Storyboard</b> and <b>Timeline</b> in real-time.
          </p>
        </div>

        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <div style={{ background: 'var(--panel-purple)', padding: '4px', borderRadius: 'var(--radius-md)', display: 'flex', gap: '4px', border: '1.5px solid var(--comic-border-light)' }}>
            <button
      ...
      {viewMode === 'scenes' ? (
              ...
              >
                ...
                <div className="field-row">
                  <div className="field" style={{ flex: 2, minWidth: '260px' }}>
                    <label>Action & Visual Scene Description</label>
                    <textarea
                      rows={2}
                      value={shot.desc}
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <div style={{ fontWeight: 700, color: 'var(--lingo-yellow)', fontSize: '14px' }}>
